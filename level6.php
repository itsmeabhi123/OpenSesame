...
<html>
<head>
  <title>Level 6- OpenSesame</title>
  <meta charset="utf-8">
  ...
  <h2>Level 6 </h2>
      <div id="qstn" class="col-lg-8">
        ...
        <?php
          ...
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=6";
              ...
              if(isset($_POST["btnSubmit"]))
              {
               $typepass=mysqli_real_escape_string($con,$_POST["txtAnswer"]);
                        if($typepass == $pass)
                        {
                          ...
                          $id=$_SESSION["userid"];
                          $sql="update ScoreTable set Level6=10,Total=60 where DcodId='$id' and ContestantName='$name'";
