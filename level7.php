...
<html>
<head>
  <title>Level 7- OpenSesame</title>
  <meta charset="utf-8">
  ...
  <h2>Level 7 </h2>
      <div id="qstn" class="col-lg-8">
        ...
        <?php
          ...
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=7";
              ...
              if(isset($_POST["btnSubmit"]))
              {
               $typepass=mysqli_real_escape_string($con,$_POST["txtAnswer"]);
                        if($typepass == $pass)
                        {
                          ...
                          $id=$_SESSION["userid"];
                          $sql="update ScoreTable set Level7=10,Total=70 where DcodId='$id' and ContestantName='$name'";
