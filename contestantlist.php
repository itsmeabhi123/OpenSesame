...
<body>
  ...
  <div class="container">  
	  <form action="contestantlist.php" method="post">	
   ...
   <div id="printdiv"> 
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
      if(isset($_POST["btnRegister"]))
      {
        ...
        $sql="select * from ContestantTable";
        if($result=mysqli_query($con,$sql))
        {

          echo "<table id='tbl' class='col-lg-7 col-lg-offset-2'>";
          echo "<th>Log ID</th><th>Dcod Id</th><th>Contestant Name</th><th>College Name </th>";
          ...
          while($row=mysqli_fetch_array($result))
          {
            ...
            $name=$row[2];
            $college=$row[3];
            echo"<tr><td>".$id."</td><td>".$did."</td><td>".$name."</td><td>".$college."</td></tr>";
