...
<html>
<head>
	<title>Level 1- OpenSesame</title>
	<meta charset="utf-8">
...
<body>
  ...
  <div class="container-fluid">  
       ...
       <h2>Level 1</h2>
        <h3 class="col-lg-offset-1">Question</h2>
      <div id="qstn" class="col-lg-8">
       
        <?php
          include('connection.php');
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=1";
      ...
      <div id="answer" class="col-lg-3">
        ...
        <div class="form-group row" id="status">
          <input type="text" class="form-control col-lg-2"  name="txtAnswer" required="" placeholder="enter your answer here">
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST")
            {
              if(isset($_POST["btnSubmit"]))
              {
                ...
                if($typepass == $pass)
                {
                  ...
                  $id=$_SESSION["userid"];
                  $sql="update ScoreTable set Level1=10,Total=10 where DcodId='$id' and ContestantName='$name'";
