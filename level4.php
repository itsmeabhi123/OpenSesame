...
<html>
<head>
  <title>Level 4- OpenSesame</title>
  <meta charset="utf-8">
  ...
  <h2>Level 4 </h2>
      <div id="qstn" class="col-lg-8">
        ...
        <?php
          ...
          // echo "hello";
          $sql="select * from QuestionTable where QuestionNo=4";
              ...
              if(isset($_POST["btnSubmit"]))
              {
               $typepass=mysqli_real_escape_string($con,$_POST["txtAnswer"]);
                        if($typepass == $pass)
                        {
                          ...
                          $id=$_SESSION["userid"];
                          $sql="update ScoreTable set Level4=10,Total=40 where DcodId='$id' and ContestantName='$name'";
